...
function ajaxHeart(e) {
  ...
  console.log(this);
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post(this.action).then(res => {
    const isHearted = this.heart.classList.toggle('heart__button--hearted');
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__bling__["a" /* $ */])('.heart-count').textContent = res.data.hearts.length;
    if (isHearted) {
...
function searchResultsHTML(quotes) {
  return quotes.map(quote => {
    return `
      <a href="/quotes/${quote.slug}" class="search__result">
...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(`/api/search?q=${this.value}`).then(res => {
      if (res.data.length) {
        searchResults.innerHTML = __WEBPACK_IMPORTED_MODULE_1_dompurify___default.a.sanitize(searchResultsHTML(res.data));
        return;
      }
      // tell them nothing came back
      searchResults.innerHTML = __WEBPACK_IMPORTED_MODULE_1_dompurify___default.a.sanitize(`<div class="search__result">No results for ${this.value}</div>`);
    }).catch(err => {
      console.error(err);
    });
  });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__sass_style_scss__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__modules_typeAhead__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__modules_heart__ = __webpack_require__(10);
...
__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__modules_typeAhead__["a" /* default */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__modules_bling__["a" /* $ */])('.search'));

const heartForms = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__modules_bling__["b" /* $$ */])('form.heart');
heartForms.on('submit', __WEBPACK_IMPORTED_MODULE_3__modules_heart__["a" /* default */]);
